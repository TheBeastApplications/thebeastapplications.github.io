...
const FCMNotifierAppDeleteAccount = () => {
  return (
    <div className="min-h-screen text-white pt-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: colors.background.primary }}>
      <div className="max-w-4xl mx-auto relative">
        ...
        >
          ...
          <div className="max-w-2xl mx-auto">
            <p style={{ color: colors.text.secondary }} className="text-lg mb-8">
              We're sorry to see you go. Please fill out the form below to request deletion of your FCM Notifier account.
            </p>
            <motion.div
        ...
        > 
          <iframe 
src="https://docs.google.com/forms/d/e/1FAIpQLScOhoYiTQ2C2u6LBBu9rPmkIDwdmjiLRciNHCXoyyMye_j6Fg/viewform?embedded=true"
...
export default FCMNotifierAppDeleteAccount;