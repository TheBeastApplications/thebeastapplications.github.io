      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          <p className="mb-8" style={{ color: colors.text.body }}>
            This Privacy Policy explains how <strong style={{ color: colors.text.primary }}>Finly - AI Fish Identifier</strong> ("the App"), developed by TheBeastApplications, collects, uses, and protects your information when you use the App.
          </p>
          ...
          <Section title="1. Information We Collect">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong style={{ color: colors.text.primary }}>Photos you provide:</strong> When you use the fish identification feature, you may capture or upload a photo for AI analysis. These images are processed to deliver identification results.
              </li>
              <li>
                <strong style={{ color: colors.text.primary }}>Catch &amp; sighting data:</strong> Information you enter about the fish you find or catch, including logs, notes, and journal entries, is stored locally on your device.
              </li>
              <li>
                <strong style={{ color: colors.text.primary }}>AI chat interactions:</strong> Questions you ask the AI Fish Expert are processed to generate responses. These conversations may be stored locally on your device.
              </li>
              <li>
          ...
          <Section title="2. How We Use Your Information">
            <ul className="list-disc pl-6 space-y-2">
              <li>Provide AI-powered fish identification from your photos.</li>
              <li>Deliver personalized facts, habitat info, and edibility notes.</li>
              <li>Power the AI Fish Expert chat feature.</li>
          ...
          <Section title="4. Data Storage & Retention">
            <p>
              Most of your data — including your catch log, sighting records, and journal — is stored locally on your device. Photos submitted for identification may be temporarily processed on external servers but are not permanently stored. You can clear your local data at any time by reinstalling the app.
            </p>
          </Section>
        ...
        <div className="text-center py-10 mt-8 text-sm" style={{ color: colors.text.muted }}>
          <p>Finly by TheBeastApplications</p>
        </div>
      </div>
    </div>
  );
...
export default FinlyPrivacyPolicy;
